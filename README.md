...
```
npm create cloudflare@latest -- --template=cloudflare/templates/morning-dew-93a6
```

## Preview Deployment

A live public deployment of this template is available at [https://morning-dew-93a6.templates.workers.dev](https://morning-dew-93a6.templates.workers.dev)
